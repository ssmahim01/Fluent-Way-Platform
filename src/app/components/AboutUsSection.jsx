      ...
      <section className="py-12 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-base font-medium mb-6">
            FluentWay is powered by a team of passionate educators and
            developers dedicated to providing the best learning experience for
            you. Led by Sayman Shakil Mahim, we strive to bring our expertise in
          ...
          <div className="flex justify-center items-center space-x-8">
            <div className="text-center">
              <img
                src="/assets/students-reading.jpg"
                alt="Reading of Students"
                className="w-24 h-24 rounded-full mx-auto"
              />
              <h3 className="font-semibold mt-4">Sayman Shakil Mahim</h3>
